...
@Tag(name = "User Controller", description = "Operations for user registration and profile management")
@RestController
...
public class UserController {
    ...
    @PutMapping("/me")
    public UserResponseDto updateProfile(@Valid @RequestBody UserRequestDto updatedUserRequestDto, Principal principal) {
